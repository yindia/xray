...
- Checkout [Integration.md](https://github.com/yindia/xray/tree/main/example/postgres/integration.md) for a detailed doc and [main.go](https://github.com/yindia/xray/tree/main/example/postgres/main.go) for code sample, demonstrating how to connect to Postgres using Xray.
